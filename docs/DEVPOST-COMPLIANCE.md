...
| DVP-05 | An open-source license is detectable at the repository root. | Root `LICENSE`, an SPDX identifier in the manifest, and repository-home verification. | Pending: the canonical MIT text and SPDX identifier are committed; public GitHub detection remains to be verified |
