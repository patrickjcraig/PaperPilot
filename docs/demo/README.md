...
- [Watch/download the demo](PaperPilot-WebMCP-demo.mp4) — 2:30, narrated and captioned.
...
The MP4 is published here for viewing and download. The WebMCP Challenge separately requires a **public YouTube URL**; this file is not a substitute for that URL or proof of Devpost submission.
